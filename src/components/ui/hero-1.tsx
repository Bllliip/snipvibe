...
const Hero1 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-red-400 from-10% via-black via-20% via-black via-80% to-blue-600 to-90% text-white flex flex-col relative overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto space-y-6 w-full">
            ...
            <div className="max-w-4xl mx-auto space-y-4 flex-1 overflow-y-auto">
                ...
                <div key={message.id} className={`flex ${message.isUser ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${
                    message.isUser 
                      ...
                      : 'bg-gradient-to-r from-black via-gray-900 to-black text-gray-300 border border-red-800'
                  }`}>
                    {message.text}
                  </div>
                </div>
              ...
              {isGenerating && (
                <div className="flex justify-start">
                  <div className="bg-gradient-to-r from-black via-gray-900 to-black border border-red-800 rounded-lg p-4 max-w-xs lg:max-w-md">
          ...
          {!showChat && (
            <div className={`relative max-w-4xl mx-auto w-full transition-all duration-500 ease-in-out ${
              ...
              <div className="bg-gradient-to-r from-red-600 from-10% via-black via-30% via-black via-70% to-blue-600 to-90% rounded-full p-4 flex items-center shadow-lg border border-red-800">
      ...
      {showChat && (
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-red-600 from-10% via-black via-30% via-black via-70% to-blue-600 to-90% border-t border-red-800 p-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-red-700 from-10% via-black via-30% via-black via-70% to-blue-700 to-90% rounded-full p-4 flex items-center shadow-lg border border-red-800">
              <button className="p-2 rounded-full hover:bg-red-800/50 transition-all">
                <Paperclip className="w-6 h-6 text-gray-300" />
              </button>
